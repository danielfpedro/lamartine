...
.factory('Notification', function(
    ...
    return {
        register: function(){
            ...
            alert('Chamando o registerByPLatform');
            _this
                .registerByPlatform(platform)
                .then(function(regId){
                    alert('resulveu o byPlatform');
        ...
        registerByPlatform: function(platform) {
            var defer = $q.defer();
            var _this = this;
            alert('Dentro do registerByPLatform');
            _this
                .getRegIdAndWatchNotification()
                .then(function(data){
                    alert('resolveu register ios');
                    defer.resolve(data);
                }, function(){
                    alert('deu ruim register ios');
                    defer.reject();
                });
            return defer.promise;
        },
        getRegIdAndWatchNotification: function(){
            var defer = $q.defer();
            var _this = this;
            if (!prod) {
            ...
            ionic.Platform.ready(function(){
                ...
                push.on('error', function(e) {
                    alert('deu erro no registro ou na mensagem');
